...
직업탐색과미래설계 = String.직업탐색과미래설계
신입생세미나 = String.신입생세미나
포트폴리오워크숍 = String.포트폴리오워크숍
포트폴리오컨설팅 = String.포트폴리오컨설팅
자기주도 = String.자기주도
진로집단상담 = String.진로집단상담
단기직무체험 = String.단기직무체험


신청경로 = String.신청경로
one상담 = String.one상담
two상담 = String.two상담
three상담 = String.three상담
포트폴리오 = String.포트폴리오
...
def makeSecondExcel(workReadSheet, writeSheet, readExcelFile):
    ...
    for build_up_row in range(build_up_base_row, build_up_max_row + 1):
        ...
        search_want_sheet(readExcelFile, name_sheet=신입생세미나, num_row_search_student_id=2,
                          num_row_sheet_base=3, student_id_computer_sheet=value_in_id, writeSheet=writeSheet, write_sheet_row=developer_sheet_base_row_wand_write, str_day_want=one상담, writeSheet_column="L")
        # ====================================================
        # 포폴워크숍
